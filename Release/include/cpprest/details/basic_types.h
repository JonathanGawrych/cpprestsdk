...
// On Windows, all strings are wide, unless requested otherwise
//
...
typedef std::wstringbuf utf16stringbuf;
...
typedef std::basic_stringbuf<utf16char> utf16stringbuf;
...
typedef utf16stringbuf stringbuf_t;
...
typedef utf8stringbuf stringbuf_t;
#define _XPLATSTR(x) _XPLATUTF8STR(x)
